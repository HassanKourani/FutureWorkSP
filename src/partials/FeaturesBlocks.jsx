        ...
        <div className="py-12 md:py-20">
          ...
          >
            ...
            >
              ...
              <h4 className="h4 mb-2">Rate my prof.</h4>
              <p className="text-lg text-gray-400 text-center">
                "Rate My Prof" is a section where students can rate and review
            ...
            >
              ...
              <h4 className="h4 mb-2">Material</h4>
              <p className="text-lg text-gray-400 text-center">
                Students can share their previous notes and coursework on a
                platform for others to access, saving time and effort for future
                students who may need the same materials.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">Meetings</h4>
              <p className="text-lg text-gray-400 text-center">
                Students can organize course-related meetings and make them
                visible to others, allowing interested students to join and
                participate.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
                A discussion forum can be created for a course, where students
                can start a conversation on a topic and others can join in to
                offer insights and help, promoting collaborative learning.
              </p>
            </div>
          </div>
        </div>
